...
@Component({
  ...
  template: `
    ...
    <p-dialog [(visible)]="dialog" [header]="editing ? 'Edit blood group' : 'Add blood group'" [modal]="true" [dismissableMask]="true" [draggable]="false" appendTo="body" [baseZIndex]="1100" [autoZIndex]="true" [keepInViewport]="true" [blockScroll]="true" [resizable]="false" [contentStyle]="{'overflow':'auto'}" [style]="{ width: 'min(440px, 94vw)' }">
